...
import thumbVideo from "@/assets/thumb-video.jpeg";
...
const TEAM_MEMBERS = [
  ...
  {
    name: "Claudio Heesch",
    role: "Responsável pelas empresas do Lucro Real e Presumido",
    photo: Claudio,
  },
  {
    name: "Isabel",
...
const About = () => {
  ...
  const [playVideo, setPlayVideo] = useState(false); // ✅ adicionada a declaração
  ...
  const values = [
    {
      ...
      title: "Excelência",
      description:
        "Buscamos sempre a perfeição em nossos serviços e no atendimento aos clientes.",
    },
    {
      icon: Eye,
      title: "Transparência",
      description:
        "Mantemos comunicação clara e honesta em todos os nossos relacionamentos.",
    },
    {
      icon: Heart,
      title: "Compromisso",
      description:
        "Dedicação total ao sucesso e crescimento dos nossos clientes.",
    },
  ];
  ...
  return (
    <section id="about" className="py-20">
      <div className="container">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="order-2 space-y-8 lg:order-1">
            ...
            <h2 className="text-3xl font-bold text-muted-foreground md:text-4xl">
              Sua <span className="text-primary">Parceria Estratégica</span> em
              Contabilidade
            </h2>
            <p className="text-lg leading-relaxed text-muted-foreground">
              Fundado em 2010, a Gis Assessoria Contábil nasceu com o propósito
              de revolucionar a prestação de serviços contábeis, combinando
              tradição, inovação e excelência no atendimento.
            </p>
            ...
            <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3">
              {values.map((value, index) => (
                <div
                  key={index}
                  className="rounded-lg bg-gray-100 p-5 text-center shadow-card"
                >
        ...
        {/* Vídeo institucional com thumbnail personalizada */}
        <div className="mt-12">
          <AspectRatio ratio={16 / 9}>
            {!playVideo ? (
              <div
                className="relative h-full w-full cursor-pointer overflow-hidden rounded-2xl shadow-elegant"
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-black/40">
                  <button
                    className="flex h-16 w-16 items-center justify-center rounded-full bg-white/80 text-primary shadow-lg transition hover:bg-white"
              ...
              <iframe
                ...
                allowFullScreen
                className="h-full w-full rounded-2xl shadow-elegant"
              />
            )}
          </AspectRatio>
        </div>
        ...
        <div className="mt-16 rounded-2xl bg-gradient-card p-8 shadow-card md:mt-20">
          <div className="text-center">
            <h3 className="mb-4 text-2xl font-bold text-muted-foreground">
              Nossa Missão
            </h3>
            <p className="mx-auto max-w-4xl text-lg leading-relaxed text-muted-foreground">
              Fornecer soluções contábeis e fiscais de alta qualidade,
              utilizando tecnologia de ponta e conhecimento especializado para
              ajudar nossos clientes a alcançar seus objetivos empresariais com
