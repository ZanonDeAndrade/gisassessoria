        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div className="space-y-8">
            <Card className="bg-gradient-card border-0 shadow-card">
              ...
              <CardContent className="space-y-4">
                <div>
                  <p className="font-medium">Rua das Empresas, 1234</p>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-accent/10 rounded-2xl p-6">
              <h3 className="text-xl font-semibold mb-4 text-center">Como Chegar</h3>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Pegue a Av. Paulista em direção ao centro, vire à direita na Rua das Empresas
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="font-medium">De Transporte Público</p>
                    <p className="text-sm text-muted-foreground">
                      Metrô Liberdade (Linha 1) + 5 minutos caminhando
                    </p>
                  </div>
                </div>
              </div>
