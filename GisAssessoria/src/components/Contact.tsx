      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12">
          {contactMethods.map((method, index) => (
            <Card key={index} className="bg-gradient-card border-0 shadow-card hover:shadow-elegant transition-smooth group text-center">
              <CardHeader>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <Card className="bg-gradient-card border-0 shadow-card">
            <CardHeader>
              <CardTitle className="text-2xl">Solicite uma Consultoria Gratuita</CardTitle>
          ...
          <div className="space-y-8">
            ...
            <Card className="bg-gradient-card border-0 shadow-card">
              <CardContent className="p-8 text-center">
                <h3 className="text-xl font-bold mb-4">Consultoria Gratuita</h3>
                <p className="text-muted-foreground mb-6">
                  Oferecemos uma análise inicial gratuita da situação contábil e fiscal da sua empresa.
                </p>
